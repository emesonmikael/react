...
const M3UPlayerLancamentos2024 = () => {
  ...
  useEffect(() => {
    const loadM3UFile = async () => {
      try {
        const response = await fetch('/Lancamentos2024.txt'); // Substitua 'playlist.m3u' pelo nome do seu arquivo
...
export default M3UPlayerLancamentos2024;